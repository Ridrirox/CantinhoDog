...
public class SwingCheckBoxDemo extends JPanel
    ...
    public SwingCheckBoxDemo() {
        ...
        coxa = new JCheckBox("Coxa");
        coxa.setMnemonic(KeyEvent.VK_C);
        coxa.setSelected(true);
    ...
    protected void updatePicture() {
        ...
        ImageIcon icon = createImageIcon("/br/com/icones/pedidosx.jpg");
