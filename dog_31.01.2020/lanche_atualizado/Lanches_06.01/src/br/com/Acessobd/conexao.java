  ...
  public Statement statement;
    ...
    public Connection conectar(){
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/burger?user=root&password=");
           //--con = DriverManager.getConnection("jdbc:mysql://localhost/burger?user=rox&password=furiododigo");
      //con = DriverManager.getConnection("jdbc:mysql://fc396979:3306/SEGURANCA?user=root&password=furiododigo");
          //con = DriverManager.getConnection("jdbc:mysql://fc421747:3306/SEGURANCA?user=rox&password=furiododigo");
            //--con = DriverManager.getConnection("jdbc:sqlite:lanches.db"); 
            //con = DriverManager.getConnection("jdbc:mysql://ROX-PC:3306/mydb?user=root&password=furiododigo");
